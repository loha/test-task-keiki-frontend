<template>
  <v-card elevation="3" class="col-6 py-6 px-6">
    <v-form v-model="isValidForm" @submit.prevent="createRoute">
      <label for="add partner" class="text-h6">Add route</label>
      <v-row class="mt-4">
        <v-col cols="6">
          <v-select
            outlined
...
@Component
export default class AddRouteForm extends Vue {
  ...
  @Watch('transports')
  transportsWatch(value: Transport[]) {
    this.transport = '';
  }
